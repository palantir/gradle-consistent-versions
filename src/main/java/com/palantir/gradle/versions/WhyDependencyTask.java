...
public class WhyDependencyTask extends DefaultTask {
    ...
    public final void taskAction() {
        ...
        Multimap<String, Line> lineByHash = new ConflictSafeLockFile(lockfile).readLocks().allLines().stream().collect(
                Multimaps.toMultimap(Line::dependentsHash, Function.identity(), HashMultimap::create));
