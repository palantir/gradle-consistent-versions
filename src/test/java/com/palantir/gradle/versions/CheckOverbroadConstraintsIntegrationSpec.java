...
@GradlePluginTests
final class CheckOverbroadConstraintsIntegrationSpec {
    ...
    @Test
    void all_versions_are_pinned(GradleInvoker gradle, RootProject project) throws IOException {
    ...
    void not_all_versions_are_pinned_throws_error_and_fix_works_and_no_new_line_is_added(
        ...
        assertThat(project.file("versions.props").text()).isEqualTo("""
            com.fasterxml.jackson.core:jackson-annotations = 2.9.5
            com.fasterxml.jackson.core:jackson-core = 2.9.3
            """);
    }
    ...
    @Test
    void fixes_are_inserted_in_the_correct_locations_new_lines_are_maintained(GradleInvoker gradle, RootProject project)
            throws IOException {
        project.file("versions.props").overwrite("""
