...
public class VersionPropsDependencyGroupImpl extends ASTWrapperPsiElement implements VersionPropsDependencyGroup {

  public VersionPropsDependencyGroupImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VersionPropsVisitor visitor) {
    visitor.visitDependencyGroup(this);
  }
